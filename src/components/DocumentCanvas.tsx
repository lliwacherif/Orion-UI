        ...
        <div className="max-w-4xl mx-auto">
          {isEditing ? (
            <textarea
              ...
              className="w-full min-h-[calc(100vh-250px)] p-6 bg-white rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none resize-none font-sans text-gray-800 leading-relaxed"
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              <div className="prose prose-lg max-w-none">
                <pre className="whitespace-pre-wrap font-sans text-gray-800 leading-relaxed" style={{ fontSize: '15px', lineHeight: '1.8' }}>
                  {editableContent}
                </pre>
              </div>
            </div>
